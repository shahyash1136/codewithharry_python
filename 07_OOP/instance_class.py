class Employee:
    ...
    def __init__(self, salary, name, bond, company):
        self.salary = salary  # create and instance attribute of name salary and assign it with salary
        self.name = name
        self.bond = bond
    ...
    def get_info(self):
        print(
            f"The name of the employee is {self.name}. Salary is {self.salary}. The bond is for  {self.bond} years"
        )
